...
const (
	Pinger_Ping_FullMethodName = "/pb.Pinger/Ping"
)
...
const (
	ReverseConnection_Connect_FullMethodName = "/pb.ReverseConnection/Connect"
)
...
var ReverseConnection_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.ReverseConnection",
